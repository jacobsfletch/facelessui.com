...
This component provides the [modal context](#context) to your app. It does not have any required props and renders nothing in the DOM. This is where the [global settings](#provider-props) are defined.
...
You can also pass a function as a child to conveniently access [modal context](#context). You could access the same context with the [useModal](#useModal) hook, but this would require a child component, see the official [Rules of Hooks](https://reactjs.org/docs/hooks-rules.html).
...
This is a hook you can use to access the [modal context](#context).
