...
export const monthNamesAbbr = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"];
...
export const formatDateTime = (timestamp?: string): string | undefined => {
  ...
  if (timestamp) {
    ...
    if (Object.prototype.toString.call(dateFromTimestamp) === "[object Date]" && !isNaN(dateFromTimestamp.getTime())) {
